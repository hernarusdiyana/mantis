...
export default function ProductsDemo() {
  ...
  const header = (
      <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
          <h4 className="m-0">Need Approve PR</h4>
      ...
      <div>
          ...
          <div className="card">
              ...
              <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                  ...
                  <Column field="pr_number" header="pr_number" sortable style={{ minWidth: '12rem' }}></Column>
                  <Column field="pr_date" header="pr_date" sortable style={{ minWidth: '16rem' }}></Column>
                  <Column field="requester_name" header="requester_name" sortable style={{ minWidth: '16rem' }}></Column>
                  <Column field="short_text" header="short_text" sortable style={{ minWidth: '10rem' }}></Column>
                  <Column field="quantity" header="quantity" sortable style={{ minWidth: '16rem' }}></Column>
                  <Column field="uom" header="uom" sortable style={{ minWidth: '16rem' }}></Column>
                  <Column field="price" header="Price" body={priceBodyTemplate} sortable style={{ minWidth: '8rem' }}></Column>
                  <Column field="spec" header="spec" sortable style={{ minWidth: '16rem' }}></Column>
